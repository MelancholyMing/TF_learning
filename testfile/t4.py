...
class Rescale(object):
    ...
    def __call__(self, sample):
        ...
        h, w = image.shape[:2]
        if isinstance(self.outpt_size, int):
            if h > w:
                new_h, new_w = self.outpt_size * h / w, self.outpt_size
            else:
                new_h, new_w = self.outpt_size, self.outpt_size * w / h
        else:
            new_h, new_w = self.outpt_size
